...
var _LtiStorage_instances, _LtiStorage_debug, _LtiStorage_setStateAndNonceCookies, _LtiPostMessage_instances, _LtiPostMessage_debug, _LtiPostMessage_getTargetWindow, _LtiPostMessage_getTargetFrame, _LtiPostMessageLog_debug;
class LtiStorage {
    constructor(debug) {
    ...
    initToolLogin(platformOidcLoginUrl, oidcLoginData, launchFrame) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.setStateAndNonce(platformOidcLoginUrl, oidcLoginData, launchFrame)
                .then(this.doLoginInitiationRedirect);
        });
    }
    setStateAndNonce(platformOidcLoginUrl, oidcLoginData, launchFrame) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                .then((hasPlatformStorage) => __awaiter(this, void 0, void 0, function* () {
                ...
                .catch((err) => {
                err && console.log(err);
                return __classPrivateFieldGet(this, _LtiStorage_instances, "m", _LtiStorage_setStateAndNonceCookies).call(this, state, nonce);
            })
                .then((hasState) => {
                let data = Object.assign(Object.assign({}, oidcLoginData), { state: state, nonce: nonce, scope: 'openid', response_type: 'id_token', response_mode: 'form_post', prompt: 'none' });
                return {
    ...
    validateStateAndNonce(state, nonce, platformOrigin, launchFrame) {
        return __awaiter(this, void 0, void 0, function* () {
            // Check cookie first
    ...
    ltiPostMessage(targetOrigin, launchFrame) {
        return new LtiPostMessage(targetOrigin, launchFrame, __classPrivateFieldGet(this, _LtiStorage_debug, "f"));
    }
}
_LtiStorage_debug = new WeakMap(), _LtiStorage_instances = new WeakSet(), _LtiStorage_setStateAndNonceCookies = function _LtiStorage_setStateAndNonceCookies(state, nonce) {
...
class LtiPostMessage {
    ...
    sendPostMessage(data, targetWindow, originOverride, targetFrameName) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                let log = new LtiPostMessageLog(__classPrivateFieldGet(this, _LtiPostMessage_debug, "f"));
                let timeout;
                let targetOrigin = originOverride || this._targetOrigin.origin;
                data.message_id = 'message-' + LtiPostMessage.secureRandom(15);
                let targetFrame;
                try {
                    targetFrame = __classPrivateFieldGet(this, _LtiPostMessage_instances, "m", _LtiPostMessage_getTargetFrame).call(this, targetWindow, targetFrameName);
                }
                catch (e) {
    ...
    ;
    sendPostMessageIfCapable(data) {
        return __awaiter(this, void 0, void 0, function* () {
            // Call capability service
            return this.sendPostMessage({ subject: 'org.imsglobal.lti.capabilities' }, __classPrivateFieldGet(this, _LtiPostMessage_instances, "m", _LtiPostMessage_getTargetWindow).call(this), '*')
                .then((capabilities) => {
                ...
                for (let i = 0; i < capabilities.supported_messages.length; i++) {
                    ...
                    return this.sendPostMessage(data, __classPrivateFieldGet(this, _LtiPostMessage_instances, "m", _LtiPostMessage_getTargetWindow).call(this), undefined, capabilities.supported_messages[i].frame);
                }
                return Promise.reject({
                    code: 'not_found',
...
_LtiPostMessage_debug = new WeakMap(), _LtiPostMessage_instances = new WeakSet(), _LtiPostMessage_getTargetWindow = function _LtiPostMessage_getTargetWindow() {
    return this._launchFrame.opener || this._launchFrame.parent;
}, _LtiPostMessage_getTargetFrame = function _LtiPostMessage_getTargetFrame(targetWindow, frameName) {
...
class LtiPostMessageLog {
    ...
    print() {
        ...
        console.groupCollapsed('%c %c request time: ' + reqTime + (this._request.timestamp ? "ms\t " + this._request.data.subject : ''), 'padding-left:' + (Math.min(reqTime, 100) * 6) + 'px; background-color: ' + (this._error.length ? (this._response.timestamp ? 'orange' : 'red') : 'green') + ';', 'padding-left:' + (10 + (Math.max(0, 10 - reqTime) * 6)) + 'px; background-color: transparent');
