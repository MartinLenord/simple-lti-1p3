...
<ul>
    ...
    <li>Users</li>
    <li>Courses</li>
        <li class="sub" onclick="document.getElementById('frame').src='http://my.tool:9001/app.php/56f3d0ed-0e0a-4ba5-a5a2-59aa4bbe6b59?iss=http%3A%2F%2Flocalhost:9001&login_hint='+login_hint+'&target_link_uri=http%3A%2F%2Flocalhost%2Fgame.php&lti_message_hint=12345'">Standard OIDC</li>
        <li class="sub" onclick="document.getElementById('frame').src='http://my.tool:9001/app.php/56f3d0ed-0e0a-4ba5-a5a2-59aa4bbe6b59?iss=http%3A%2F%2Flocalhost:9001&login_hint='+login_hint+'&target_link_uri=http%3A%2F%2Flocalhost%2Fgame.php&lti_message_hint=12345&response_mode=ims_web_message'">Post message</li>
    <li>Settings</li>
</ul>
